...
class DetalleYOrdersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detallesYOrdersAdapter =
            DetallesYOrdersAdapter(this
            ) { order -> viewModel.handleEvent(DetallesYOrdersEvent.DeleteOrder(order)) }
    ...
    private fun getSelectedCustomerId(): Int {
        ...
        return intent.getIntExtra(Constantes.idIntentName, 0)
    }
